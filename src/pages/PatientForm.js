...
const PatientForm = (userInfo) => {
  ...
  function handleSignUp() {
    ...
    if (!dob) setDobIncluded(false);
    else setDobIncluded(true);
  ...
  return (
    <div className="text-white mt-[76px]">
      <div className="px-10 md:px-20 lg:px-[110px]">
        ...
        <h2 className="mt-[43px] text-xl md:text-3xl font-bold leading-9 mb-9">
        ...
        <form className="flex flex-col gap-6" autoComplete="on">
          ...
          <input
            ...
            className="bg-[#24AE7C] py-3 text-white hover:bg-[#0E8784] min-w-20 mx-auto md:w-full mt-12 rounded-lg justify-center items-center text-base font-semibold leading-normal tracking-tight "
          />
        </form>
      </div>
      <div>
