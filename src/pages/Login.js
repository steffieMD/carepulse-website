...
const Login = ({ signUpInfo }) => {
  ...
  function handleLogIn() {
    currentAccount = signUpInfo?.find((info) => info.email === email);
  ...
  return (
    <>
      <div className="flex text-white text-left w-full flex-1">
        <div className=" flex flex-col justify-center  w-full md:w-1/2 px-10 md:px-20 lg:px-[110px] h-[70vh]">
          <div className="flex flex-col justify-center flex-1 gap-16">
            <div className="mt-12">
              <h1 className="mb-[18px] text-4xl font-bold leading-[44px]">
                Hi there, ....
              </h1>
              <span className="text-[#abb8c4] text-lg font-medium leading-7 tracking-tight">
            ...
            <div>
              <form className="flex flex-col gap-6" autoComplete="on">
                ...
                >
                  Incorrect login! Check email or phone number!
                </span>
                <input
                  onClick={(e) => {
                    e.preventDefault();
                    handleLogIn();
                    console.log("storedInfo:", signUpInfo);
                  }}
                  type="submit"
                  value="log in"
          ...
          <span className="absolute bottom-0">@carepulse copyright</span>
        </div>

        <div className="hidden md:block w-1/2 text-black absolute top-0 -right-3 h-[100vh]">
          <img
            src={logInImg}
